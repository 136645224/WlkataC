...
void MT4_UART::writecoordinate(int motion, int position, float x, float y, float z, float a)
{
    string val_motion;
    string val_position;
    string coordinate;
...
void MT4_UART::writeangle(int position, float x, float y, float z, float a)
{
    string val_position;
    string val_angle;
